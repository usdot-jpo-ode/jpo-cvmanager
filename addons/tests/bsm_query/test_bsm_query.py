...
import pytest
from images.bsm_query import bsm_query

from images.bsm_query.bsm_query import create_message, process_message, run
...
@patch("images.bsm_query.bsm_query.ThreadPoolExecutor")
