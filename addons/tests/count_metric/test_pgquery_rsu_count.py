...
from images.count_metric import pgquery_rsu
import os


@patch("images.count_metric.pgquery_rsu.sqlalchemy")
...
@patch("images.count_metric.pgquery_rsu.db", new=None)
@patch("images.count_metric.pgquery_rsu.init_tcp_connection_engine")
