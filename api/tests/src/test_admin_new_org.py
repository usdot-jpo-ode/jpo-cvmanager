...
import pytest
import src.admin_new_org as admin_new_org
import tests.data.admin_new_org_data as admin_new_org_data
import sqlalchemy
...
@patch('src.admin_new_org.add_organization')
def test_entry_post(mock_add_org):
    ...
    with patch("src.admin_new_org.request", req):
...
@patch('src.admin_new_org.check_safe_input')
@patch('src.admin_new_org.pgquery.insert_db')
