...
import pytest
import src.admin_new_user as admin_new_user
import tests.data.admin_new_user_data as admin_new_user_data
import sqlalchemy
...
@patch('src.admin_new_user.get_allowed_selections')
def test_entry_get(mock_get_allowed_selections):
    ...
    with patch("src.admin_new_user.request", req):
...
@patch('src.admin_new_user.add_user')
...
@patch('src.admin_new_user.pgquery')
...
@patch('src.admin_new_user.query_and_return_list')
...
@patch('src.admin_new_user.check_safe_input')
@patch('src.admin_new_user.check_email')
@patch('src.admin_new_user.pgquery.insert_db')
