...
def test_middleware_keycloak_class_call_user_unauthorized(mock_response, mock_request, mock_get_user_role):
    # create instance
    app = Mock()
    middleware_keycloak_instance = middleware_keycloak.Middleware(app)
    # call
...
@patch('src.middleware_keycloak.Request')
@patch('src.middleware_keycloak.Response')
def test_middleware_keycloak_class_call_user_authorized(mock_response, mock_request, mock_get_user_role):
    # create instance
    app = Mock()
...
@patch('src.middleware_keycloak.Response')
@patch('src.middleware_keycloak.KeycloakOpenID')
def test_middleware_keycloak_class_call_exception(mock_keycloak,mock_response, mock_request):
    # create instance
    app = Mock()
    mock_request.return_value.method = "GET"
    mock_request.return_value.path = "/rsu-google-auth"
