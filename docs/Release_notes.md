...
- Refactoring
  - Large transition of features from the Python API to the Java Intersection API
  - The Python API is no longer a required service and is only used for RSU and WZDx features.
  - PostgreSQL now utilizes Flyway to safely manage database migrations
...
- [CDOT PR 247](https://github.com/CDOT-CV/jpo-cvmanager/pull/247): Updating Released Dependencies
