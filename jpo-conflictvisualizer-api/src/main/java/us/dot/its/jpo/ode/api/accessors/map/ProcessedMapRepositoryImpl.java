...
public class ProcessedMapRepositoryImpl implements ProcessedMapRepository {
    ...
    public List<ProcessedMap> findProcessedMaps(Query query) {
        // mongoTemplate.find(query, ProcessedMap<LineString>.class, collectionName);
        List<Bson> returnedMaps = mongoTemplate.find(query, Bson.class, collectionName);
        ...
        // return new ArrayList<ProcessedMap>();
    }
