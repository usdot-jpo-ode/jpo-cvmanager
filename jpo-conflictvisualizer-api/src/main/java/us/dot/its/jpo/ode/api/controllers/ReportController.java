...
public class ReportController {
    ...
    public byte[] generateReport(
            ...
            @RequestParam(name = "road_regulator_id", required = false) String roadRegulatorID,
            ...
            @RequestParam(name = "end_time_utc_millis", required = true) long endTime) {
                ...
                ReportDocument document = reportService.buildReport(intersectionID, roadRegulatorID, startTime, endTime);
    ...
    public ResponseEntity<List<ReportDocument>> listReports(
            ...
            Query query = reportRepo.getQuery(reportName, intersectionID, roadRegulatorID, startTime, endTime, false, latest);
    ...
    //     // Query query = reportRepo.getQuery(null, null, null, null, null, false, false);
    //     // long count = reportRepo.getQueryResultCount(query);
    ...
    //     // Query query = reportRepo.getQuery("CmReport_1234_-1_1698710400000_1699315200000", null, null, null, null, true, true);
    //     // long count = reportRepo.getQueryResultCount(query);
    //     // System.out.println("Returning Report List with Size: " + count);
    ...
    //     ReportDocument document = buildReport(intersectionID, roadRegulatorID, startTime, endTime);
