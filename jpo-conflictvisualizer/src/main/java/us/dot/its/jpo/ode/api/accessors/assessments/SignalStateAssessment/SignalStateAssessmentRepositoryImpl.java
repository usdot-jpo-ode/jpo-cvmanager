...
import org.springframework.data.mongodb.core.MongoTemplate;
    ...
    public class SignalStateAssessmentRepositoryImpl implements SignalStateAssessmentRepository{
        ...
        public long getQueryResultCount(Query query){
            return mongoTemplate.count(query, SignalStateAssessment.class, "CmSignalStateAssessment");
        }

        public List<SignalStateAssessment> find(Query query){
            return mongoTemplate.find(query, SignalStateAssessment.class, "CmSignalStateAssessment");
        }
