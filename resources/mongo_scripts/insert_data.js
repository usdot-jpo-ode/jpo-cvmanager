...
database.ProcessedBsm.insertMany([
  {
    ...
    properties: {
      ...
      msgCnt: 16,
      speed: 15.32,
      timeStamp: addSeconds(datePreviousHour, messageCount * msgTimeDeltaSeconds).toISOString(),
      ...
      id: 'ABC12345',
      odeReceivedAt: addSeconds(datePreviousHour, messageCount * msgTimeDeltaSeconds).toISOString(),
      originIp: '8.8.8.8',
    },
    recordGeneratedAt: addSeconds(datePreviousHour, messageCount++ * msgTimeDeltaSeconds),
  },
  {
    geometry: {
      coordinates: [-104.9029669, 39.6283543],
...
print('start date', addSeconds(datePreviousHour, 0).toISOString())
print('end date', addSeconds(datePreviousHour, messageCount * msgTimeDeltaSeconds).toISOString())
