...
def test_write_counts():
    ...
    mongo_counter.mongo_db = mock_mongo_db

    mongo_counter.write_counts(["test"])
...
def test_count_query_bsm():
    ...
    result = mongo_counter.count_query("bsm", start_dt, end_dt)
...
def test_run_mongo_counter(mock_count_query, mock_write_counts):
    ...
    mongo_counter.run_mongo_counter()
    ...
    mock_write_counts.assert_called_with(expected)
