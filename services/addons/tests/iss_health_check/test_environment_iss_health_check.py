...
def test_get_storage_type_gcp():
    actual_value = environment.process_storage_type("gcp", "postgres")
    assert actual_value == "gcp"


def test_get_storage_type_postgres():
    actual_value = environment.process_storage_type("postgres", "postgres")
...
def test_get_storage_type_invalid():
    with pytest.raises(ValueError):
        environment.process_storage_type("test", "postgres")


def test_get_storage_type_unset():
    environment.process_storage_type(None, "postgres") == "postgres"