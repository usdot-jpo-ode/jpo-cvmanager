...
from addons.images.rsu_ping_fetch import pgquery_rsu
from datetime import datetime
from freezegun import freeze_time
import os

@patch('addons.images.rsu_ping_fetch.pgquery_rsu.sqlalchemy')
...
@patch('addons.images.rsu_ping_fetch.pgquery_rsu.db', new=None)
@patch('addons.images.rsu_ping_fetch.pgquery_rsu.init_tcp_connection_engine')
