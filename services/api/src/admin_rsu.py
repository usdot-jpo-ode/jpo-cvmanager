...
def get_rsu_data(rsu_ip):
    query = (
        ...
        "JOIN public.snmp_versions AS snmp_ver ON snmp_ver.snmp_version_id = rsus.snmp_protocol_id "
...
def modify_rsu(rsu_spec):
    ...
    try:
        ...
        query = (
            ...
            f"snmp_protocol_id=(SELECT snmp_version_id FROM public.snmp_versions WHERE nickname = '{rsu_spec['snmp_version_group']}'), "
