...
CSM_EMAIL_APP_USERNAME=get_env_var("CSM_EMAIL_APP_USERNAME", error=CSM_AUTH_ENABLED)
CSM_EMAIL_APP_PASSWORD=get_env_var("CSM_EMAIL_APP_PASSWORD", error=CSM_AUTH_ENABLED)
