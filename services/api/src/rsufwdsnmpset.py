...
def config_msgfwd_yunex(rsu_ip, snmp_creds, dest_ip, udp_port, rsu_index, psid, tx):
    try:
        ...
        if tx:
            ...
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.2.{index} x {msgpsid} ".format(
                index=rsu_index, msgpsid=psid
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.3.{index} s {destip} ".format(
                index=rsu_index, destip=dest_ip
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.4.{index} i {port} ".format(
                index=rsu_index, port=udp_port
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.5.{index} i 2 ".format(
                index=rsu_index
            )
            ...
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.6.{index} x {dt} ".format(
                index=rsu_index, dt=start_hex
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.7.{index} x {dt} ".format(
                index=rsu_index, dt=end_hex
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.8.{index} i 0 ".format(
                index=rsu_index
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.20.2.1.9.{index} i 4".format(
                index=rsu_index
            )
        ...
        # x.1206.4.2.18.5.2.1.12 - int : Yunex feature. Do not turn on. (0: off, 1: on)
            ...
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.2.{index} x {msgpsid} ".format(
                index=rsu_index, msgpsid=psid
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.3.{index} s {destip} ".format(
                index=rsu_index, destip=dest_ip
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.4.{index} i {port} ".format(
                index=rsu_index, port=udp_port
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.5.{index} i 2 ".format(
                index=rsu_index
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.6.{index} i -100 ".format(
                index=rsu_index
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.7.{index} i 1 ".format(
                index=rsu_index
            )
            ...
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.8.{index} x {dt} ".format(
                index=rsu_index, dt=start_hex
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.9.{index} x {dt} ".format(
                index=rsu_index, dt=end_hex
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.10.{index} i 4 ".format(
                index=rsu_index
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.11.{index} i 0 ".format(
                index=rsu_index
            )
            snmp_mod += "1.3.6.1.4.1.1206.4.2.18.5.2.1.12.{index} i 0".format(
                index=rsu_index
            )
...
def config_del(rsu_ip, manufacturer, snmp_creds, msg_type, rsu_index):
    if manufacturer == "Kapsch" or manufacturer == "Commsignia":
        try:
            ...
            output = e.stderr.decode("utf-8").split("\n")[:-1]
            logging.error(
                f"Encountered error while deleting RSU SNMP config: {output[-1]}"
            )
            response = snmperrorcheck.check_error_type(output[-1])
            code = 500
        finally:
        ...
        try:
            ...
            if msg_type.lower() == "bsm":
                snmp_mods += "1.3.6.1.4.1.1206.4.2.18.5.2.1.10.{index} i 6 ".format(
                    index=rsu_index
                )
            if msg_type.lower() == "spat":
                snmp_mods += "1.3.6.1.4.1.1206.4.2.18.20.2.1.9.{index} i 6 ".format(
                    index=rsu_index
                )
            ...
            logging.error(
                f"Encountered error while deleting Yunex RSU SNMP config: {output[-1]}"
            )
            response = snmperrorcheck.check_error_type(output[-1])
            code = 500
    else:
...
def config_init(rsu_ip, manufacturer, snmp_creds, dest_ip, msg_type, index):
    ...
    if manufacturer == "Kapsch" or manufacturer == "Commsignia":
        ...
        return (
            "Supported RSU manufacturers are currently only Commsignia, Kapsch and Yunex",
            501,
        )
...
def post(request):
    ...
    response, code = config_init(
        ...
        request["snmp_creds"],
        request["args"]["dest_ip"],
        request["args"]["msg_type"],
        request["args"]["rsu_index"],
    )
