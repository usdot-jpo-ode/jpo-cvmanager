...
return_value_single_result = [
    ({
        "ip": "10.0.0.1", 
        "health": '1', 
        "expiration": "2022-11-02T00:00:00.00Z"
    },)
]
...
expected_rsu_data_single_result = {
  "10.0.0.1": {
    "health": '1',
    "expiration": "11/01/2022 06:00:00 PM"
  }
}

expected_rsu_data_single_null_result = {
  "10.0.0.1": None
}
...
return_value_multiple_result = [
    ...
    ({
        "ip": "10.0.0.2", 
        "health": '0', 
        "expiration": "2022-11-03T00:00:00.00Z"
    },)
]
...
expected_rsu_data_multiple_result = {
  ...
  "10.0.0.2": {
    "expiration": "11/02/2022 06:00:00 PM",
    "health": '0'
  }
}

expectedQuery = "SELECT jsonb_build_object('ip', rd.ipv4_address, 'health', scms_health_data.health, 'expiration', scms_health_data.expiration) " \
