...
ping_expected_single = {'172.16.28.233': 
...
ping_expected_multiple = {'172.16.28.233': {'checked_timestamps': ['2022-06-14T18:46:58'], 
                        'online_statuses': ['1']}, 
                        '172.16.28.156': {'checked_timestamps': ['2022-06-14T18:56:59'], 
                        'online_statuses': ['1']}, 
                        '172.16.28.134': {'checked_timestamps': ['2022-06-14T18:57:04'], 
                        'online_statuses': ['1']}}

####################################### get_last_online_data ##################################

last_online_query = "SELECT ping.timestamp " \
                    "FROM public.ping " \
                    "JOIN (" \
...
last_online_query_return = [[datetime.strptime('06/14/2022 07:44:09 PM', '%m/%d/%Y %I:%M:%S %p')]]
...
mock_ping_return_single = {'172.16.28.233': {'checked_timestamps': ['2022-06-14T18:46:58'], 'online_statuses': ['1']}}
                    
online_status_expected_single = {
...
mock_ping_return_multiple = {'172.16.28.233': {'checked_timestamps': ['2022-06-14T18:46:58'], 'online_statuses': ['1']}, 
                                '172.16.28.156': {'checked_timestamps': ['2022-06-14T18:56:59'], 'online_statuses': ['1']}, 
                                '172.16.28.134': {'checked_timestamps': ['2022-06-14T18:57:04'], 'online_statuses': ['1']}}
