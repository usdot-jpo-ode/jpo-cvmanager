...
request_args_bad_type = multidict.MultiDict(
    [("message", 14), ("start", "2022-05-23T12:00:00"), ("end", "2022-05-24T12:00:00")]
)
...
rsu_counts_query_bq = (
    "SELECT RSU, Road, SUM(Count) as Count FROM `Fake_table` "
...
date = pytz.timezone("UTC").localize(
    datetime.strptime("2023-01-01T07:00:00", "%Y-%m-%dT%H:%M:%S")
)
...
rsu_one = multidict.MultiDict(
    [("RSU", "10.11.81.24"), ("Road", "Region 1"), ("Count", "0")]
)
rsu_two = multidict.MultiDict(
    [("RSU", "172.16.28.136"), ("Road", "I70"), ("Count", "8472")]
)
rsu_three = multidict.MultiDict(
    [("RSU", "172.16.28.23"), ("Road", "C-470"), ("Count", "0")]
)
