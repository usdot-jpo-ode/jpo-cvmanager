...
os.environ['GCP_PROJECT_ID'] = 'gcp-project-id'
os.environ['MOOVE_AI_SEGMENT_AGG_STATS_TABLE'] = 'moove-ai-segment-agg-stats-table'
os.environ['MOOVE_AI_SEGMENT_EVENT_STATS_TABLE'] = 'moove-ai-segment-event-stats-table'
