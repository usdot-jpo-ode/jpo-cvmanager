...
def test_config_msgfwd_yunex_tx(mock_perform_snmp_mods, mock_subprocess_run):
    ...
    psid = 5678
    tx = True
    result = rsufwdsnmpset.config_msgfwd_yunex(
...
@patch("api.src.rsufwdsnmpset.set_rsu_status")
@patch("api.src.rsufwdsnmpset.subprocess.run")
def test_config_del_kapsch_set_rsu_status_failure(
    ...
    result = rsufwdsnmpset.config_del(
        rsu_ip, manufacturer, snmp_creds, msg_type, rsu_index
    )
...
def test_config_del_yunex_bsm(mock_subprocess_run, mock_set_rsu_status):
    ...
    mock_subprocess_run.assert_called_once_with(
        "snmpset -v 3 -u test_username -a SHA -A test_password -x AES -X test_password -l authpriv 192.168.0.20 1.3.6.1.4.1.1206.4.2.18.5.2.1.10.1 i 6 ",
        shell=True,
        capture_output=True,
        check=True,
    )
...
def test_config_del_yunex_spat(mock_subprocess_run, mock_set_rsu_status):
    ...
    mock_set_rsu_status.assert_not_called()
    mock_subprocess_run.assert_called_once_with(
        "snmpset -v 3 -u test_username -a SHA -A test_password -x AES -X test_password -l authpriv 192.168.0.20 1.3.6.1.4.1.1206.4.2.18.20.2.1.9.1 i 6 ",
        shell=True,
        capture_output=True,
        check=True,
    )
...
def test_config_init_kapsch_bsm(mock_config_msgfwd_yunex, mock_config_msgfwd):
    ...
    result = rsufwdsnmpset.config_init(
        rsu_ip, manufacturer, snmp_creds, dest_ip, msg_type, rsu_index
    )
...
@patch("api.src.rsufwdsnmpset.config_msgfwd")
@patch("api.src.rsufwdsnmpset.config_msgfwd_yunex")
def test_config_init_kapsch_unsupported_msg_type(
    mock_config_msgfwd_yunex, mock_config_msgfwd
):
    manufacturer = "Kapsch"
    msg_type = "test_msg_type"
    result = rsufwdsnmpset.config_init(
...
@patch("api.src.rsufwdsnmpset.config_msgfwd")
@patch("api.src.rsufwdsnmpset.config_msgfwd_yunex")
def test_config_init_commsignia_unsupported_msg_type(
...
def test_config_init_yunex_bsm(mock_config_msgfwd_yunex, mock_config_msgfwd):
    ...
    expected_result = "success"
    assert result == expected_result
    mock_config_msgfwd_yunex.assert_called_once_with(
        rsu_ip, snmp_creds, dest_ip, "46800", rsu_index, "20", False
    )
    mock_config_msgfwd.assert_not_called()
...
def test_config_init_yunex_spat(mock_config_msgfwd_yunex, mock_config_msgfwd):
    ...
    assert result == expected_result
    mock_config_msgfwd_yunex.assert_called_once_with(
        rsu_ip, snmp_creds, dest_ip, "44910", rsu_index, "8002", True
    )
    mock_config_msgfwd.assert_not_called()
...
def test_config_init_yunex_map(mock_config_msgfwd_yunex, mock_config_msgfwd):
    ...
    assert result == expected_result
    mock_config_msgfwd_yunex.assert_called_once_with(
        rsu_ip, snmp_creds, dest_ip, "44920", rsu_index, "E0000017", True
    )
    mock_config_msgfwd.assert_not_called()
...
def test_config_init_yunex_ssm(mock_config_msgfwd_yunex, mock_config_msgfwd):
    ...
    assert result == expected_result
    mock_config_msgfwd_yunex.assert_called_once_with(
        rsu_ip, snmp_creds, dest_ip, "44900", rsu_index, "E0000015", True
    )
    mock_config_msgfwd.assert_not_called()
...
def test_config_init_yunex_srm(mock_config_msgfwd_yunex, mock_config_msgfwd):
    ...
    assert result == expected_result
    mock_config_msgfwd_yunex.assert_called_once_with(
        rsu_ip, snmp_creds, dest_ip, "44930", rsu_index, "E0000016", False
    )
    mock_config_msgfwd.assert_not_called()
...
@patch("api.src.rsufwdsnmpset.config_msgfwd")
@patch("api.src.rsufwdsnmpset.config_msgfwd_yunex")
def test_config_init_yunex_unsupported_msg_type(
    mock_config_msfwd_yunex, mock_config_msgfwd
):
    manufacturer = "Yunex"
    msg_type = "test_msg_type"
...
@patch("api.src.rsufwdsnmpset.config_msgfwd")
@patch("api.src.rsufwdsnmpset.config_msgfwd_yunex")
def test_config_init_unsupported_manufacturer(
    mock_config_msfwd_yunex, mock_config_msgfwd
):
    manufacturer = "test_manufacturer"
    msg_type = "test_msg_type"
...
def test_config_msgfwd_raw_false(mock_perform_snmp_mods, mock_set_rsu_status):
    ...
    # Call the function
    response, code = rsufwdsnmpset.config_msgfwd(
...
def test_config_msgfwd_yunex_exception(
    ...
    # Call the function
    response, code = rsufwdsnmpset.config_msgfwd_yunex(
        rsu_ip, snmp_creds, dest_ip, udp_port, rsu_index, psid, tx
    )
    mock_check_error_type.assert_called_once_with("any")
    # Assert the function result
...
@patch("api.src.rsufwdsnmpset.set_rsu_status", return_value="success")
def test_config_msgfwd_exception(
    mock_set_rsu_status,
