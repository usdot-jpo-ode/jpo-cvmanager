...
import pytest
import api.src.unsub_error_emails as unsub_error_emails
import api.tests.data.unsub_error_emails_data as unsub_error_emails_data
import sqlalchemy
...
@patch('api.src.unsub_error_emails.unsubscribe_user')
...
###################################### Testing Functions ##########################################
@patch('api.src.unsub_error_emails.smtp_error_handler.unsubscribe_user')
