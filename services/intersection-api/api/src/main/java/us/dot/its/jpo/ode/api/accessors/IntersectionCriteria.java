...
public class IntersectionCriteria {

    private final Criteria criteria;

    public IntersectionCriteria() {
        this.criteria = new Criteria();
    }

    public IntersectionCriteria(Criteria criteria) {
    ...
    public IntersectionCriteria withinTimeWindow(@Nonnull String fieldName,
        ...
        if (startEpochMillis != null && endEpochMillis != null) {
            ...
            criteria.and(fieldName).gte(new Date(startEpochMillis));
        } else if (endEpochMillis != null) {
            criteria.and(fieldName).lte(new Date(endEpochMillis));
        }
        return this;
    }
