...
@Component
public class IntersectionReferenceAlignmentEventAggregationRepositoryImpl
                implements IntersectionReferenceAlignmentEventAggregationRepository, PageableQuery {

        private final MongoTemplate mongoTemplate;

        private final String collectionName = "CmIntersectionReferenceAlignmentEventAggregation";
        private final String DATE_FIELD = "notificationGeneratedAt";
        private final String INTERSECTION_ID_FIELD = "IntersectionID";

        @Autowired
        public IntersectionReferenceAlignmentEventAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
         ...
         * @return the paginated data that matches the given criteria
         */
        public Page<IntersectionReferenceAlignmentEventAggregation> findLatest(
                        Integer intersectionID,
                        Long startTime,
                        Long endTime) {
                Criteria criteria = new IntersectionCriteria()
                ...
                return wrapSingleResultWithPage(
                                mongoTemplate.findOne(
                                                ...
                                                IntersectionReferenceAlignmentEventAggregation.class,
                                                collectionName));
        }
         ...
         * @return the paginated data that matches the given criteria
         */
        public Page<IntersectionReferenceAlignmentEventAggregation> find(
                        Integer intersectionID,
                        Long startTime,
                        Long endTime,
                        Pageable pageable) {
        ...
        public void add(IntersectionReferenceAlignmentEventAggregation item) {
