...
@Component
public class MapMessageCountProgressionEventAggregationRepositoryImpl
        implements MapMessageCountProgressionEventAggregationRepository, PageableQuery {

    private final MongoTemplate mongoTemplate;

    private final String collectionName = "CmMapMessageCountProgressionEventAggregation";
    private final String DATE_FIELD = "eventGeneratedAt";
    private final String INTERSECTION_ID_FIELD = "intersectionID";

    @Autowired
    public MapMessageCountProgressionEventAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<MapMessageCountProgressionEventAggregation> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime) {
        Criteria criteria = new IntersectionCriteria()
        ...
        return wrapSingleResultWithPage(
                mongoTemplate.findOne(
                        ...
                        MapMessageCountProgressionEventAggregation.class,
                        collectionName));
    }
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<MapMessageCountProgressionEventAggregation> find(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            Pageable pageable) {
    ...
    public void add(MapMessageCountProgressionEventAggregation item) {
