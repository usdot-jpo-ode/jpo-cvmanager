...
@Component
public class SignalStateConflictEventAggregationRepositoryImpl
        implements SignalStateConflictEventAggregationRepository, PageableQuery {

    private final MongoTemplate mongoTemplate;

    private final String collectionName = "CmSignalStateConflictEventAggregation";
    private final String DATE_FIELD = "eventGeneratedAt";
    private final String INTERSECTION_ID_FIELD = "intersectionID";

    @Autowired
    public SignalStateConflictEventAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<SignalStateConflictEventAggregation> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime) {
        Criteria criteria = new IntersectionCriteria()
        ...
        return wrapSingleResultWithPage(
                mongoTemplate.findOne(
                        ...
                        SignalStateConflictEventAggregation.class,
                        collectionName));
    }
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<SignalStateConflictEventAggregation> find(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            Pageable pageable) {
    ...
    public void add(SignalStateConflictEventAggregation item) {
