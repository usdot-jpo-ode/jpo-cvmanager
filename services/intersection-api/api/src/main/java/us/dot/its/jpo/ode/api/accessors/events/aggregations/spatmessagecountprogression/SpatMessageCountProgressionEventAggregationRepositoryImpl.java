...
@Component
public class SpatMessageCountProgressionEventAggregationRepositoryImpl
        implements SpatMessageCountProgressionEventAggregationRepository, PageableQuery {

    private final MongoTemplate mongoTemplate;

    private final String collectionName = "CmSpatMessageCountProgressionEventAggregation";
    private final String DATE_FIELD = "eventGeneratedAt";
    private final String INTERSECTION_ID_FIELD = "intersectionID";

    @Autowired
    public SpatMessageCountProgressionEventAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<SpatMessageCountProgressionEventAggregation> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime) {
        Criteria criteria = new IntersectionCriteria()
        ...
        return wrapSingleResultWithPage(
                mongoTemplate.findOne(
                        ...
                        SpatMessageCountProgressionEventAggregation.class,
                        collectionName));
    }
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<SpatMessageCountProgressionEventAggregation> find(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            Pageable pageable) {
    ...
    public void add(SpatMessageCountProgressionEventAggregation item) {
