...
@Component
public class SpatMinimumDataEventAggregationRepositoryImpl
                implements SpatMinimumDataEventAggregationRepository, PageableQuery {

        private final MongoTemplate mongoTemplate;

        private final String collectionName = "CmSpatMinimumDataEventAggregation";
        private final String DATE_FIELD = "eventGeneratedAt";
        private final String INTERSECTION_ID_FIELD = "intersectionID";

        @Autowired
        public SpatMinimumDataEventAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
         ...
         * @return the paginated data that matches the given criteria
         */
        public Page<SpatMinimumDataEventAggregation> findLatest(
                        Integer intersectionID,
                        Long startTime,
                        Long endTime) {
                Criteria criteria = new IntersectionCriteria()
                ...
                return wrapSingleResultWithPage(
                                mongoTemplate.findOne(
                                                ...
                                                SpatMinimumDataEventAggregation.class,
                                                collectionName));
        }
         ...
         * @return the paginated data that matches the given criteria
         */
        public Page<SpatMinimumDataEventAggregation> find(
                        Integer intersectionID,
                        Long startTime,
                        Long endTime,
                        Pageable pageable) {
        ...
        public void add(SpatMinimumDataEventAggregation item) {
