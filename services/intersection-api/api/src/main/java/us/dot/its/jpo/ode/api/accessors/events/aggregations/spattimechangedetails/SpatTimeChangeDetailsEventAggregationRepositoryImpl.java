...
@Component
public class SpatTimeChangeDetailsEventAggregationRepositoryImpl
        implements SpatTimeChangeDetailsEventAggregationRepository, PageableQuery {
    ...
    @Autowired
    public SpatTimeChangeDetailsEventAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
