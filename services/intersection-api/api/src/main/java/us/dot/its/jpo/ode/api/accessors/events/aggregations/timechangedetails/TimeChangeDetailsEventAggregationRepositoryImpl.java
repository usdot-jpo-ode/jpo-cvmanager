package us.dot.its.jpo.ode.api.accessors.events.aggregations.timechangedetails;
...
@Component
public class TimeChangeDetailsEventAggregationRepositoryImpl
                implements TimeChangeDetailsEventAggregationRepository, PageableQuery {
        ...
        @Autowired
        public TimeChangeDetailsEventAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
         ...
         * @return the paginated data that matches the given criteria
         */
        public Page<TimeChangeDetailsEventAggregation> findLatest(
                        Integer intersectionID,
                        Long startTime,
                        Long endTime) {
                Criteria criteria = new IntersectionCriteria()
                ...
                return wrapSingleResultWithPage(
                                mongoTemplate.findOne(
                                                ...
                                                TimeChangeDetailsEventAggregation.class,
                                                collectionName));
        }
         ...
         * @return the paginated data that matches the given criteria
         */
        public Page<TimeChangeDetailsEventAggregation> find(
                        Integer intersectionID,
                        Long startTime,
                        Long endTime,
                        Pageable pageable) {
        ...
        public void add(TimeChangeDetailsEventAggregation item) {
