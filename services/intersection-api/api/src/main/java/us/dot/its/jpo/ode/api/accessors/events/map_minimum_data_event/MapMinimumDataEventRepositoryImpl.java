...
@Component
public class MapMinimumDataEventRepositoryImpl
	 ...
	 * @return the paginated data that matches the given criteria
	 */
	public Page<MapMinimumDataEvent> findLatest(
			Integer intersectionID,
			Long startTime,
			Long endTime) {
		Criteria criteria = new IntersectionCriteria()
	 ...
	 * @return the paginated data that matches the given criteria
	 */
	public Page<MapMinimumDataEvent> find(
			Integer intersectionID,
			Long startTime,
			Long endTime,
			Pageable pageable) {
	...
	public List<IDCount> getAggregatedDailyMapMinimumDataEventCounts(int intersectionID, Long startTime,
			Long endTime) {
