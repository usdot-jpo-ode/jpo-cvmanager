...
@Component
public class StopLinePassageNotificationRepositoryImpl
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<StopLinePassageNotification> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime) {
        Criteria criteria = new IntersectionCriteria()
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<StopLinePassageNotification> find(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            Pageable pageable) {
        Criteria criteria = new IntersectionCriteria()
                ...
                .withinTimeWindow(DATE_FIELD, startTime, endTime, false);
        Sort sort = Sort.by(Sort.Direction.DESC, DATE_FIELD);
        return findPage(mongoTemplate, collectionName, pageable, criteria, sort, StopLinePassageNotification.class);
    }
