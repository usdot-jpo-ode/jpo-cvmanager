...
@Component
public class EventStateProgressionNotificationAggregationRepositoryImpl
        implements EventStateProgressionNotificationAggregationRepository, PageableQuery {
    ...
    @Autowired
    public EventStateProgressionNotificationAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<EventStateProgressionNotificationAggregation> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime) {
        Criteria criteria = new IntersectionCriteria()
        ...
        return wrapSingleResultWithPage(
                mongoTemplate.findOne(
                        ...
                        EventStateProgressionNotificationAggregation.class,
                        collectionName));
    }
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<EventStateProgressionNotificationAggregation> find(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            Pageable pageable) {
    ...
    public void add(EventStateProgressionNotificationAggregation item) {
