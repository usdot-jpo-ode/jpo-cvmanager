...
@Component
public class SignalGroupAlignmentNotificationAggregationRepositoryImpl
        implements SignalGroupAlignmentNotificationAggregationRepository, PageableQuery {

    private final MongoTemplate mongoTemplate;

    private final String collectionName = "CmSignalGroupAlignmentNotificationAggregation";
    private final String DATE_FIELD = "notificationGeneratedAt";
    private final String INTERSECTION_ID_FIELD = "intersectionID";

    @Autowired
    public SignalGroupAlignmentNotificationAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<SignalGroupAlignmentNotificationAggregation> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime) {
        Criteria criteria = new IntersectionCriteria()
        ...
        return wrapSingleResultWithPage(
                mongoTemplate.findOne(
                        ...
                        SignalGroupAlignmentNotificationAggregation.class,
                        collectionName));
    }
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<SignalGroupAlignmentNotificationAggregation> find(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            Pageable pageable) {
    ...
    public void add(SignalGroupAlignmentNotificationAggregation item) {
