...
@Component
public class SpatTimeChangeDetailsNotificationAggregationRepositoryImpl
        implements SpatTimeChangeDetailsNotificationAggregationRepository, PageableQuery {

    private final MongoTemplate mongoTemplate;

    private final String collectionName = "CmSpatTimeChangeDetailsNotificationAggregation";
    private final String DATE_FIELD = "notificationGeneratedAt";
    private final String INTERSECTION_ID_FIELD = "intersectionID";

    @Autowired
    public SpatTimeChangeDetailsNotificationAggregationRepositoryImpl(MongoTemplate mongoTemplate) {
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<TimeChangeDetailsNotificationAggregation> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime) {
        Criteria criteria = new IntersectionCriteria()
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<TimeChangeDetailsNotificationAggregation> find(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            Pageable pageable) {
