...
@Component
public class ProcessedSsmRepositoryImpl implements ProcessedSsmRepository, PageableQuery {

    private final MongoTemplate mongoTemplate;

    private final String collectionName = "ProcessedSsm";
    private final String DATE_FIELD = "timeStamp";
    private final String INTERSECTION_ID_FIELD = "intersectionId";
    private final String RECORD_GENERATED_AT_FIELD = "recordGeneratedAt";
    private final String VALIDATION_MESSAGES_FIELD = "validationMessages";

    public ProcessedSsmRepositoryImpl(MongoTemplate mongoTemplate) {
     ...
     * @return the paginated data that matches the given criteria
     */
    public Page<ProcessedSsm> findLatest(
            Integer intersectionID,
            Long startTime,
            Long endTime,
            boolean compact) {
