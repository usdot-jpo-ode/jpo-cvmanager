...
public class ReportsController {
        ...
        public ResponseEntity<Page<ReportDocument>> generateReport(
                ...
                return ResponseEntity.ok(new PageImpl<ReportDocument>(java.util.Collections.singletonList(document),
                                pageable, 1));
