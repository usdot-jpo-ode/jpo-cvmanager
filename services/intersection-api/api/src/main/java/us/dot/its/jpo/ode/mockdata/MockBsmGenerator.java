...
public class MockBsmGenerator {
    ...
    public static List<BasicSafetyMessage> getJsonBsms() {
        ...
        try {
            BasicSafetyMessage bsm = objectMapper.readValue(bsmString,
                    BasicSafetyMessage.class);
            bsms.add(bsm);
