...
public class MockNotificationGenerator {
    public static ConnectionOfTravelNotification getConnectionOfTravelNotification() {
        ...
        notification.setNotificationText(
                "Mocked Connection of Travel Notification, created from Mocked Connection of Travel Assessment.");
        return notification;
    }
    ...
    public static IntersectionReferenceAlignmentNotification getIntersectionReferenceAlignmentNotification() {
        ...
        notification.setNotificationText(
                "Mocked Intersection Reference Alignment Notification, created from Mocked Intersection Reference Alignment Event.");
        return notification;
    }
    ...
    public static LaneDirectionOfTravelNotification getLaneDirectionOfTravelNotification() {
        ...
        notification.setNotificationText(
                "Mocked Lane Direction of Travel Notification, created from Mocked Lane Direction of Travel Assessment.");
        return notification;
    }
    ...
    public static SignalGroupAlignmentNotification getSignalGroupAlignmentNotification() {
        ...
        notification.setNotificationText(
                "Mocked Signal Group Alignment notification, created from Mocked Signal Group Alignment Event.");
        return notification;
    }
    ...
    public static SignalStateConflictNotification getSignalStateConflictNotification() {
        ...
        notification.setNotificationText(
                "Mocked Signal State Conflict Notification, created from Mocked Signal State Conflict Event.");
        return notification;
    }
    ...
    public static MapBroadcastRateNotification getMapBroadcastRateNotification() {
        ...
        notification.setNotificationText(
                "Mocked Map Broadcast Rate Notification, created from Mocked Map Broadcast Rate Event");
        return notification;
    }
    ...
    public static SpatBroadcastRateNotification getSpatBroadcastRateNotification() {
        ...
        notification
                .setNotificationText("Spat Broadcast Rate Notification, created from Mocked Spat Broadcast Rate Event");
        return notification;
    }
    ...
    public static StopLineStopNotification getStopLineStopNotification() {
        ...
        notification.setAssessment(assessment);
        notification.setNotificationText(
                "Stop Line Stop Notification, Percent Time stopped on green: " + group.getTimeStoppedOnGreen()
                        + " For Signal group: " + group.getSignalGroup() + " Exceeds Maximum Allowable Percent");
