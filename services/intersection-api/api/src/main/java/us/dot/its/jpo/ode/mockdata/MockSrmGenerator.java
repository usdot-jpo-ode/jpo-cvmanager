...
public class MockSrmGenerator {
    ...
    public static List<SignalRequestMessageMessageFrame> getJsonSrms() {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.registerModule(new JavaTimeModule());

        ArrayList<SignalRequestMessageMessageFrame> srms = new ArrayList<>();

        try {
            SignalRequestMessageMessageFrame srm = objectMapper.readValue(srmString,
