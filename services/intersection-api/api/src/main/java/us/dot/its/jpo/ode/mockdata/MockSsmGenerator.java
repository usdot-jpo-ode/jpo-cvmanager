...
public class MockSsmGenerator {
    ...
    public static List<SignalStatusMessageMessageFrame> getJsonSsms() {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.registerModule(new JavaTimeModule());

        ArrayList<SignalStatusMessageMessageFrame> ssms = new ArrayList<>();

        try {
            SignalStatusMessageMessageFrame ssm = objectMapper.readValue(ssmString,
