...
public class SignalGroupAlignmentEventRepositoryImplTest {
    ...
    public void testFindSignalGroupAlignmentEvents() {
        ...
        Mockito.doReturn(expected).when(mongoTemplate).find(query, SignalGroupAlignmentEvent.class,
    ...
    public void testGetSignalGroupAlignmentEventsByDay() {
        ...
        List<IDCount> actualResults = repository.getAggregatedDailySignalGroupAlignmentEventCounts(intersectionID,
                startTime, endTime);
