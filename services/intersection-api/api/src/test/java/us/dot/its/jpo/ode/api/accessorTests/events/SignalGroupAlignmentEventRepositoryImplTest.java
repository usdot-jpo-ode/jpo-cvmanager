...
public class SignalGroupAlignmentEventRepositoryImplTest {
    ...
    @Test
    public void testFindSignalGroupAlignmentEvents() {
        Query query = new Query();
        List<SignalGroupAlignmentEvent> expected = new ArrayList<>();

        Mockito.doReturn(expected).when(mongoTemplate).find(query, SignalGroupAlignmentEvent.class, "CmSignalGroupAlignmentEvents");

        List<SignalGroupAlignmentEvent> results = repository.find(query);

        assertThat(results).isEqualTo(expected);
    }

    @Test
    public void testGetSignalGroupAlignmentEventsByDay() {
        ...
        List<IDCount> actualResults = repository.getSignalGroupAlignmentEventsByDay(intersectionID, startTime, endTime);
