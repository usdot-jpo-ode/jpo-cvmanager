...
public class BsmEventRepositoryImplTest {
    ...
    public void testFindBsms() {
        ...
        Mockito.doReturn(expectedBsms).when(mongoTemplate).find(query, BsmEvent.class, "CmBsmEvents");
    ...
    public void testGetBsmEventsByDay() {
        ...
        List<IDCount> actualResults = repository.getBsmEventsByDay(intersectionID, startTime, endTime);
