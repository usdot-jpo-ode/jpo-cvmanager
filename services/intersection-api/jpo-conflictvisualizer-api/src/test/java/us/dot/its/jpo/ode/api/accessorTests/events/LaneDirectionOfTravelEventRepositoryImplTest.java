...
public class LaneDirectionOfTravelEventRepositoryImplTest {
    ...
    @Test
    public void testFindLaneDirectionOfTravelEvents() {
        Query query = new Query();
        List<LaneDirectionOfTravelEvent> expected = new ArrayList<>();

        Mockito.doReturn(expected).when(mongoTemplate).find(query, LaneDirectionOfTravelEvent.class, "CmLaneDirectionOfTravelEvents");

        List<LaneDirectionOfTravelEvent> results = repository.find(query);
    ...
    public void testGetLaneDirectionOfTravelEventsByDay() {
        ...
        List<IDCount> actualResults = repository.getLaneDirectionOfTravelEventsByDay(intersectionID, startTime, endTime);
