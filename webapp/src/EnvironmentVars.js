class EnvironmentVars {
  ...
  static getMapboxInitViewState() {
    const MAPBOX_INIT_LATITUDE = process.env.REACT_APP_MAPBOX_INIT_LATITUDE
    const MAPBOX_INIT_LONGITUDE = process.env.REACT_APP_MAPBOX_INIT_LONGITUDE
    const MAPBOX_INIT_ZOOM = process.env.REACT_APP_MAPBOX_INIT_ZOOM
