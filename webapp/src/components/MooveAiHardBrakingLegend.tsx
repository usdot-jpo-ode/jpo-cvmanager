    ...
    <div className="hardBrakingLegend">
      ...
      <div style={gridStyle}>
        <div style={gridRowStyle}>
          ...
          <Typography fontSize="small">0-249 Hard Brakes</Typography>
        </div>
        <div style={gridRowStyle}>
          <div
            style={{ width: '20px', height: '20px', backgroundColor: 'rgb(255, 255, 0)', marginRight: '10px' }}
          ></div>
          <Typography fontSize="small">250-499 Hard Brakes</Typography>
        </div>
        <div style={gridRowStyle}>
          <div
            style={{ width: '20px', height: '20px', backgroundColor: 'rgb(255, 165, 0)', marginRight: '10px' }}
          ></div>
          <Typography fontSize="small">500-749 Hard Brakes</Typography>
        </div>
        <div style={gridRowStyle}>
          <div style={{ width: '20px', height: '20px', backgroundColor: 'rgb(255, 0, 0)', marginRight: '10px' }}></div>
          <Typography fontSize="small">750+ Hard Brakes</Typography>
        </div>
        <div style={gridBottomStyle}></div>
      </div>
      <Typography fontSize="small" style={{ marginLeft: '10px' }}>
