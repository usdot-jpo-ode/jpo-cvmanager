    ...
    if (this.props.isLoginActive()) {
      ...
      for (let i = 0; i < this.props.ipList.length; i++) {
        try {
          ...
          console.log(data)
          if (data.os === true) {
            this.setState({'osUpdateAvailable': [...this.state.osUpdateAvailable, ipList[i].properties.Ipv4Address]}, () => console.log(this.state.osUpdateAvailable));
          }
          if (data.firmware === true) {
            this.setState({'fwUpdateAvailable': [...this.state.fwUpdateAvailable, ipList[i].properties.Ipv4Address]}, () => console.log(this.state.osUpdateAvailable));
          }
  ...
  render() {
    return (
      <div id="snmpdiv">
        ...
        <button id="updatebtn" onClick={this.performCheck}>Check For Updates</button>
