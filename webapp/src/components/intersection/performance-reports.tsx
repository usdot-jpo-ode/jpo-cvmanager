...
import { ReportListFilters } from './reports/report-list-filters'
import { ReportListTable } from './reports/report-list-table'
import ReportsApi, { ReportMetadata } from '../../apis/intersections/reports-api'
import { ReportGenerationDialog } from './reports/report-generation-dialog'
...
type LogsListInnerProps = {
  theme: any
  open: boolean
}

const LogsListInner = styled('div', { shouldForwardProp: (prop) => prop !== 'open' })<LogsListInnerProps>(
  ({ theme, open }: LogsListInnerProps) => ({
    flexGrow: 1,
    overflow: 'hidden',
