...
import trafficLightIconUnknown from '../../icons/map/traffic-light-icon-unknown.svg'
import trafficLightIconRedFlashing from '../../icons/map/traffic-light-icon-red-flashing.svg'
import trafficLightIconRed1 from '../../icons/map/traffic-light-icon-red-1.svg'
import trafficLightIconYellowRed1 from '../../icons/map/traffic-light-icon-yellow-red-1.svg'
import trafficLightIconYellow1 from '../../icons/map/traffic-light-icon-yellow-1.svg'
import trafficLightIconGreen1 from '../../icons/map/traffic-light-icon-green-1.svg'
