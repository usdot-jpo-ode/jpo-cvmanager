...
export const selectLoading = (state) => state.adminAddOrganization.loading;
export const selectSuccessMsg = (state) => state.adminAddOrganization.value.successMsg;
export const selectErrorState = (state) => state.adminAddOrganization.value.errorState;
export const selectErrorMsg = (state) => state.adminAddOrganization.value.errorMsg;
