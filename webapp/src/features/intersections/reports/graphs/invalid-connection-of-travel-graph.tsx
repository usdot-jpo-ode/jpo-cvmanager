...
interface InvalidConnectionOfTravelGraphProps {
...
const InvalidConnectionOfTravelGraph: React.FC<InvalidConnectionOfTravelGraphProps> = ({ data }) => {
...
export default InvalidConnectionOfTravelGraph
