...
export const refreshSnmpFwdConfig = createAsyncThunk("config/refreshSnmpFwdConfig", async (ipList, { getState }) => {
...
export const submitSnmpSet = createAsyncThunk("config/submitSnmpSet", async (ipList, { getState }) => {
  const currentState = getState();
  const token = selectToken(currentState);
  const organization = selectOrganizationName(currentState);
...
export const deleteSnmpSet = createAsyncThunk("config/deleteSnmpSet", async (ipList, { getState }) => {
  const currentState = getState();
  const token = selectToken(currentState);
  const organization = selectOrganizationName(currentState);
  const destIp = selectDestIp(currentState);
...
export const filterSnmp = createAsyncThunk("config/filterSnmp", async (ipList, { getState }) => {
  const currentState = getState();
  const token = selectToken(currentState);
  const organization = selectOrganizationName(currentState);
...
export const rebootRsu = createAsyncThunk("config/rebootRsu", async (ipList, { getState }) => {
  const currentState = getState();
  const token = selectToken(currentState);
  const organization = selectOrganizationName(currentState);
